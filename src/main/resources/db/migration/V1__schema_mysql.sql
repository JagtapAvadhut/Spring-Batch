...
-- Create BATCH_STEP_EXECUTION_SEQ table
...
-- Insert initial data into BATCH_JOB_EXECUTION_SEQ table
INSERT INTO BATCH_JOB_EXECUTION_SEQ (ID, UNIQUE_KEY)
    SELECT * FROM (SELECT 0 AS ID, '0' AS UNIQUE_KEY) AS tmp
    WHERE NOT EXISTS(SELECT * FROM BATCH_JOB_EXECUTION_SEQ);

-- Create BATCH_JOB_SEQ table
...
-- Insert initial data into BATCH_JOB_SEQ table
